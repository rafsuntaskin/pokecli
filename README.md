...
```bash
npm install -g https://github.com/rafsuntaskin/pokecli/releases/download/v0.1.3/pokecli-0.1.3.tgz
```

Replace `v0.1.3` and `0.1.3` with the latest release version.
